export function javaPrompt(args: { code: string; symbolName: string | null }): { system: string; prompt: string } {
  const system =
    "You are a senior Java QA engineer. You write JUnit 5 tests (and Mockito if needed). Output ONLY code.";
