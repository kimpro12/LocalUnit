...
exports.activateProCommand = activateProCommand;
exports.isProActivated = isProActivated;
...
function isProActivated(context) {
    return context.globalState.get("localunit.pro.activated") === true;
}
